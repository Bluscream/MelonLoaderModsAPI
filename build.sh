...
${nuget_cmd} install src/MelonLoaderModsAPI/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/MelonLoaderModsAPI.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/MelonLoaderModsAPI.dll \
-recurse:'src/MelonLoaderModsAPI/*.cs' \
-doc:bin/MelonLoaderModsAPI.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/MelonLoaderModsAPI.dll was created successfully"
fi
